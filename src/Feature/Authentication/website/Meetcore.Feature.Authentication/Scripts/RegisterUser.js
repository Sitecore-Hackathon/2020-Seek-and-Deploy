        ...
        function (_) {
            return {
                ...
                setDynamicData: function (propKey) {
                    ...
                    if (this.Parameters[propKey] && !_.findWhere(items, { itemId: this.Parameters[propKey] })) {
                        var currentField = {
                            itemId: this.Parameters[propKey],
                            name: this.Parameters[propKey] + " - " + (this.ValueNotInListText.Text || "value not in the selection list")
                        };
                ...
                getData: function () {
                    var formData = this.MapRegisterUserForm.getFormData(), keys = _.keys(formData);
